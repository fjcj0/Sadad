...
const AiPage = () => {
    return (
        <div className="w-full min-h-[85vh] flex flex-col items-center p-3 justify-center gap-y-5">
            ...
            <div className="w-full flex gap-y-5 flex-col items-center text-center justify-center">
