...
const ChatPage = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            setMessage('');
            const response = await axios.post('http://localhost:4500/ask/ai', { question: message });
            const aiAnswer: string = response.data;
    ...
    return (
        <div className="w-screen min-h-[100vh] flex flex-col items-start justify-start">
            ...
            <div className="w-full h-[100vh] flex flex-col gap-5 overflow-y-auto px-5 pb-36 pt-24">
